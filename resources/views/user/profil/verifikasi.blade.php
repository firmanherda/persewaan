                ...
                <div class="card-body">
                  ...
                  <div class="row align-items-center pt-4 pb-3">
                    ...
                    <div class="col-md-9 pe-5">
                      ...
                      <input type="text" class="form-control form-control-lg" placeholder="Nama Lengkap sesuai di Identitas"/>
                  ...
                  <div class="row align-items-center py-3">
                    ...
                    <div class="col-md-9 pe-5">
                      ...
                      <input type="text" class="form-control form-control-lg" placeholder="Nomer Identitas" />
                  ...
                  <div class="row align-items-center py-3">
                    ...
                    <div class="col-md-9 pe-5">
                      ...
                      <input type="text" class="form-control form-control-lg" placeholder="Alamat sesuai Identitas" />
